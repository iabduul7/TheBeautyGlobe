                        ...
                        <div class="content">
                            ...
                            <ul class="meta">
                                <li><i class="fa fa-calendar"></i><span class="date-time"><span
                                            class="date">20</span><span class="separator">-</span><span class="month">Jul</span></span>
                                </li>
                            </ul>
                                ...
                                <div class="product-details-content">
                                    ...
                                    <div class="product-description">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                            ...
                                            quis nostrud exercitation ullamco,Proin lectus ipsum, gravida
                                    ...
                                    <div class="single-product-quantity">
                                        <form class="add-quantity" action="#">
                                            ...
                                            <div class="add-to-link">
                                                <button class="product-add-btn" data-text="add to cart">add to cart
                                                </button>
                                            </div>
                                        </form>
                                    </div>
